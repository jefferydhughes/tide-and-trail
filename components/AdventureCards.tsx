...
const cards = [
  {tag:'NOMADS CAFÉ', title:'Secret Coffee Hike', meta:'Saturday · 8–10 AM', text:'The trailhead stays secret until we send the coordinates. We bring the coffee. You bring a mug. $5', icon:Coffee, href:'/nomads', image:'/assets/logos/Nomads-cafe-logo.jpg', alt:'Nomads Café logo'},
