...
const cards = [
  {tag:'NOMADS CAFE', title:'Secret Coffee Hike', meta:'Saturday · 8–10 AM ', text:'The trailhead stays secret until we send the coordinates. We bring the coffee. You bring a mug. $5', icon:Coffee, href:'/community', image:'public/assets/logos/Nomads-cafe-logo.jpg', alt:'Nomads Cafe logo'},
