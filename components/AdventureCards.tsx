...
const cards = [
  {tag:'HUSH HUSH', title:'Sunrise coffee hike', meta:'Saturday · 7–10 AM · 36 spots', text:'The trailhead stays secret until you RSVP. We bring the coffee. You bring a mug.', icon:Coffee, href:'/community', image:'/assets/photography/hush-hush-wide.jpg', alt:'Hush Hush community coffee hike poster'},
