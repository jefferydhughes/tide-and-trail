...
const cards = [
  {tag:'Nomad\'s Cafe', title:'Sunrise coffee hike', meta:'Saturday · 7–10 AM · 36 spots', text:'The trailhead stays secret until the coordinates drop. We bring the coffee. You bring a mug.', icon:Coffee, href:'/community', image:'/images/nathan-dumlao-ozVQrfENFOs-unsplash.jpg', alt:'Hush Hush community coffee event at Nomad\'s Cafe'},
